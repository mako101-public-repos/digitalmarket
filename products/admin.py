...
class ProductAdmin(admin.ModelAdmin):
    list_display = ['__str__', 'id', 'description', 'price', 'sale_price', 'is_available']  # fields that are visible in the Product Admin
    search_fields = ['title', 'description', 'id']  # what can we search by
