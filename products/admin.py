...
class ProductAdmin(admin.ModelAdmin):
    ...
    list_display = ['slug', '__str__', 'id', 'description', 'seller',
                    'price', 'sale_price', 'on_sale', 'is_available']  # fields that are visible in the Product Admin
    ...
    search_fields = ['title', 'description', 'seller', 'id']  # what can we search by

    list_filter = ['price', 'sale_price', 'seller', 'is_available']  # for the filter option on the right
    list_editable = ['seller', 'on_sale', 'is_available']  # which fields we can edit right from the admin page!
